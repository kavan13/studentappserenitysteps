...
public class StudentCURDTestWithSteps extends TestBase {
    static String firstName = "Abcd" + TestUtils.getRandomValue();
    static String lastName = "Xyz" + TestUtils.getRandomValue();
    static String programme = "Api Testing";
    static String email = TestUtils.getRandomValue() + "axyz@gmail.com";
